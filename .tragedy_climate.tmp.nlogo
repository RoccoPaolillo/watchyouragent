...
[
  ...
  energia-richiesta          ;; amount of energia collected at each move
 ; tax-paid
]
...
units-own
[
  food-stored        ;; amount of energia collected from grazing
...
to graze  ;; goat procedure
 ...
 ; lt (random-float 90)
 ; fd 1
  set riserve_unità (food-stored + [riserva_personale] of one-of farmers with [user-id = [owner#] of myself])
