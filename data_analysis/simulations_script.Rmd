...
dftlong %>%
  ...
  geom_point(aes(color = color, shape = proportion), size = 2) +
     scale_color_manual("gruppo", values=c(azzurro="cyan", blu="blue", rosso = "red",giallo = "orange",rosa = "pink")) +
  scale_shape_manual("proportion", values = c("propnrgacq" = "triangle","propnewnrg" = "square"), name = "indicator",
...
ggsave(file= paste0("images/propturn",i,".png"),width = 8, height = 3)
